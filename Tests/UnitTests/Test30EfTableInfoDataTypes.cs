...
namespace Tests.UnitTests
{
    public class Test30EfTableInfoDataTypes
    {
        ...
        public void Test10DataIntDoubleOk()
        {
            ...
            list[i++].ToString().ShouldEqual("SqlColumnName: DataDecimalSmallPrecision, SqlTypeName: decimal, ClrColumName: DataDecimalSmallPrecision, ClrColumnType: System.Decimal, IsPrimaryKey: False, PrimaryKeyOrder: 0, IsNullable: False, MaxLength: 9");
        ...
        public void Test20DataStringByteOk()
        {
            ...
            list[i++].ToString().ShouldEqual("SqlColumnName: DataStringVarchar, SqlTypeName: varchar, ClrColumName: DataStringVarchar, ClrColumnType: System.String, IsPrimaryKey: False, PrimaryKeyOrder: 0, IsNullable: True, MaxLength: 1");
            list[i++].ToString().ShouldEqual("SqlColumnName: DataStringVarchar25, SqlTypeName: varchar, ClrColumName: DataStringVarchar25, ClrColumnType: System.String, IsPrimaryKey: False, PrimaryKeyOrder: 0, IsNullable: True, MaxLength: 50");
            ...
            list[i++].ToString().ShouldEqual("SqlColumnName: DataStringVarchar25NotNull, SqlTypeName: varchar, ClrColumName: DataStringVarchar25NotNull, ClrColumnType: System.String, IsPrimaryKey: False, PrimaryKeyOrder: 0, IsNullable: False, MaxLength: 50");
